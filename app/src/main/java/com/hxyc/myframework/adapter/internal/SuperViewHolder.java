...
public class SuperViewHolder extends RecyclerView.ViewHolder implements ChainSetter<SuperViewHolder> {
    ...
    @Override
    public SuperViewHolder setText(int viewId, @StringRes int strRes) {
        TextView textView = getView(viewId);
    ...
    @Override
    public SuperViewHolder setBackgroundBitmap(int viewId, Bitmap bitmap) {
        View view = getView(viewId);
    ...
    @Override
    public SuperViewHolder setTypeface(int viewId, Typeface typeface) {
        TextView textView = getView(viewId);
