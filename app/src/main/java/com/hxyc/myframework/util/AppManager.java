...
public class AppManager {
    ...
    // Activity栈
    private static Stack<AppCompatActivity> sActivityStack;
    // 单例模式
    ...
    public void addActivity(AppCompatActivity activity) {
        if (sActivityStack == null) {
            sActivityStack = new Stack<AppCompatActivity>();
        }
    ...
    public AppCompatActivity currentActivity() {
        AppCompatActivity activity = sActivityStack.lastElement();
        return activity;
    }
    ...
    public void removeActivity(Class<?> cls) {
        for (AppCompatActivity activity : sActivityStack) {
    ...
    public static void copyToClipboard(Context context, String text) {
        ClipboardManager cbm = (ClipboardManager) context.getApplicationContext().getSystemService(AppCompatActivity.CLIPBOARD_SERVICE);
     ...
     * @param act
     */
    public static void closeInputMethod(AppCompatActivity act) {
